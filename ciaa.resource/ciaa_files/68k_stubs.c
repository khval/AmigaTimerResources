...
extern struct Interrupt * _ciaa_AddICRVector(struct ciaaIFace *Self, struct Library * resource, WORD iCRBit, struct Interrupt * interrupt);
extern VOID _ciaa_RemICRVector(struct ciaaIFace *Self, struct Library * resource, WORD iCRBit,  struct Interrupt * interrupt);
extern WORD _ciaa_AbleICR(struct ciaaIFace *Self, struct Library * resource,  WORD mask);
...
STATIC void stub_AddICRVector_ppc(ULONG *regarray)
{
	 regarray[REG68K_D0/4] = (ULONG) _ciaa_AddICRVector(NULL,
...
STATIC void stub_AbleICR_ppc(ULONG *regarray)
{
	 regarray[REG68K_D0/4] = _ciaa_AbleICR(NULL,
		(struct Library *) regarray[REG68K_A6/4],
		(WORD) regarray[REG68K_D0/4]);
}
...
STATIC void stub_SetICR_ppc(ULONG *regarray)
{
	 regarray[REG68K_D0/4] = _ciaa_SetICR(NULL,
		(struct Library *) regarray[REG68K_A6/4],
		(WORD) regarray[REG68K_D0/4]);;
}
